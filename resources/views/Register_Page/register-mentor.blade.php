...
<head>
    ...
    <!-- Connecting CSS -->
    <link rel="stylesheet" href="{{ asset('css/Register-mentor.css') }}">
    <!-- Jakarta Plus Fonts -->
...
<body class="flex justify-center items-center min-h-screen">
        ...
        <div class="container m-auto">
            <div class="page-choosing-category min-h-40 ">
                ...
                <div class="heading-section">
                    <h2 class="header-choosing-register text-center my-4">Ayo Mulai Daftar Untuk Mendampingi!</h2>
                </div>
    ...
    <script src="{{ asset('js/Register-mentor.js') }}"></script>
</body>
